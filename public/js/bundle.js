...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ2V0c29tZTc4NiIsImEiOiJjazV4Ym5uaW0wazJsM25ta21mMzhmaHpwIn0.Z5P7zcD2rNyx3VuluoXVQA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/getsome786/ck5xbswud0ksx1in4meiia98e',
    scrollZoom: false //   center: [136.997638, 35.164618],
    //   zoom: 10
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            return _context2.abrupt("return", location.reload(true));
  ...
  regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_bXCGcS6mmduavwLAcDwXuaAz007ggHiApe');
            _context.prev = 1;
            _context.next = 4;
